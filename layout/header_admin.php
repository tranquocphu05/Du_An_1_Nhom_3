	...
	<div class="d-flex flex-row flex-column-fluid page">
		...
		<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
			...
			<div class="brand flex-column-auto" id="kt_brand">
				...
				<a href="/du_an_1_Nhom3/?role=admin" class="brand-logo">
					...
					<ul class="menu-nav">
						<li class="menu-item menu-item-active" aria-haspopup="true">
							<a href="" class="menu-link">
								...
								<a style="border: 2px blue solid; font-size: 20px;" href="/du_an_1_Nhom3/?role=client">Vể Trang Người Dùng</a>
							</a>
						</li>
						...
						<div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
							...
							<ul class="menu-nav">
								...
								<li class="menu-item menu-item-submenu" data-menu-toggle="click" aria-haspopup="true">
									<a href="/du_an_1_Nhom3/?role=client" class="menu-link menu-toggle"> 
