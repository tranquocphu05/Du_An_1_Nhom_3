                               ...
                               <!-- nav trang chủ -->
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class=""> <a class="nav-link" href="/du_an_1_Nhom3/?role=client">Trang chủ<span class="sr-only">(current)</span></a> </li>
                                        ...
                                        <li class="dropdown"> <a  href="">Chính sách bảo mật</a>
                                           
                                        </li>

                                        <li class="dropdown"><a href="">Chính sách đổi trả</a>
